...
DEFAULT_REGISTER_URL = "https://agentgate.ai/api/agents/register"
...
class AgentIdentity:
    ...
    async def register(
        ...
        """
        Register a new agent with the AgentGate backend.
    ...
    def to_options(self, **overrides) -> "AgentGateOptions":
        """
        Returns a AgentGateOptions configured with this agent's API key.
        Extra keyword arguments are forwarded as option overrides.
        """
        from .gate import AgentGateOptions
        return AgentGateOptions(
