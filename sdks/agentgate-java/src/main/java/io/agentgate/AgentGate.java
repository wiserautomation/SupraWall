...
public class agentgate {
    private static String apiKey = System.getenv("AGENTGATE_API_KEY");
    private static String apiUrl = System.getenv().getOrDefault("agentgate_API_URL", "https://api.agentgate.io/v1/evaluate");
    ...
    public static String evaluate(String agentId, String toolName, String jsonArguments) throws PolicyViolationException, IOException, InterruptedException {
        if (apiKey == null) throw new IllegalArgumentException("AGENTGATE_API_KEY is required");
        ...
        if (response.statusCode() != 200) {
           throw new IOException("agentgate Network Error: Failing closed");
        }
