...
export default function AdminOverviewPage() {
    ...
    const kpiData = [
        ...
        { title: "Agents Active", value: stats.totalAgents, icon: Server, color: "text-indigo-500", bg: "bg-indigo-500/10" },
    ...
    return (
        <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
            <div className="flex justify-between items-end mb-8">
                ...
                <Link href="/admin/analytics" className="px-4 py-2 bg-indigo-600/10 border border-indigo-500/20 text-indigo-400 rounded-lg text-xs font-bold hover:bg-indigo-600/20 transition-all flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="col-span-1 bg-[#0A0A0A] border-white/5">
                    <CardHeader>
                        <CardTitle className="text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] flex items-center gap-2">
                            <Shield className="w-4 h-4" /> Decisions (24h)
                        </CardTitle>
                    </CardHeader>
