...
import { ArrowRight, BookOpen, Shield, Code, Server, FastForward, CheckCircle2 } from "lucide-react";
    ...
    return (
        <div className="space-y-12 animate-in fade-in zoom-in-95 duration-500 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Link href="/docs/quickstart" className="group p-6 rounded-2xl bg-neutral-900 border border-white/5 hover:border-indigo-500/50 hover:bg-neutral-800 transition-all flex flex-col items-start text-left">
                    <div className="p-3 bg-indigo-500/20 text-indigo-400 rounded-lg mb-4 group-hover:scale-110 transition-transform">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                        ...
                        <Link key={fw.name} href={fw.href} className="flex items-center p-4 bg-neutral-900 border border-white/5 rounded-xl hover:bg-neutral-800 hover:border-white/20 transition-all group">
                            <fw.icon className="w-5 h-5 text-neutral-400 mr-3 group-hover:text-indigo-400 transition-colors" />
            ...
            <div className="space-y-6 pt-6 border-t border-white/5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="p-5 border border-white/5 rounded-xl bg-black/40">
                        <h4 className="font-bold text-white flex items-center gap-2 mb-2"><CheckCircle2 className="w-4 h-4 text-indigo-500" /> Real-time Audit</h4>
