        ...
        <div className="space-y-12 pb-20 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pt-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="relative group">
                        <textarea
                            ...
                            className="w-full h-80 bg-[#0D0D0D] border border-white/10 rounded-xl p-6 font-mono text-sm text-emerald-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 resize-none transition-all"
                            spellCheck={false}
                        />
                        <button
                            onClick={validateJson}
                            className="absolute bottom-4 right-4 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-sm font-bold shadow-lg transition-transform active:scale-95"
                        >
                            Validate Spec
                        </button>
                    </div>
                ...
                <div className="space-y-8">
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                <div key={idx} className="flex gap-4 p-4 hover:bg-white/[0.02] rounded-xl transition-colors">
                                    <div className="font-mono text-sm text-emerald-400 shrink-0">{item.title}</div>
                    ...
                    <div className="pt-4">
                        <a href="https://github.com/wiserautomation" target="_blank" className="inline-flex items-center gap-2 text-emerald-400 hover:text-emerald-300 font-semibold transition-colors">
            ...
            {/* CALL TO ACTION */}
            <section className="bg-emerald-600 rounded-3xl p-8 md:p-12 relative overflow-hidden">
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold text-white tracking-tight">Ready to integrate?</h2>
                        <p className="text-emerald-100 opacity-80">Download the reference library or start securing agents in the cloud.</p>
                    </div>
