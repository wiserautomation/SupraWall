...
```tsx
const badgeMarkdown = `[![EU AI Act Compliant](https://www.supra-wall.com/api/badge/${agent.id})](https://www.supra-wall.com?ref=github-badge)`;
...
```
<script src="https://www.supra-wall.com/widget/countdown.js"></script>
...
```html
<!-- Badge style -->
<script src="https://www.supra-wall.com/widget/countdown.js" defer></script>
