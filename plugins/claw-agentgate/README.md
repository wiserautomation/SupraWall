...
```bash
npm install @agentgate/claw
```

### 2. Secure your Agent

agentgate wraps your `OpenClaw` instance to intercept every click, type, and navigation action.
...
// ❌ Error: Action blocked by agentgate policy.
```
...
---
[Get your API Key](https://agentgate-rho.vercel.app/login) | [View Docs](https://agentgate-rho.vercel.app/docs/frameworks/openclaw)
