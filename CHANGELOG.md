...
- Public packages published unscoped on npm (`suprawall`, `suprawall-langchain`, `suprawall-vercel-ai`, `suprawall-claw`) and PyPI (`langchain-suprawall`)
- Internal workspace packages use the `@suprawall/*` scope locally via `file:` links
