...
## Setup (2 minutes)
1. Go to https://supra-wall-rho.vercel.app and create a free account
...
const securedAgent = withGateAPI(myAgent, {
  ...
  endpoint: process.env.GATEAPI_ENDPOINT || "https://supra-wall-rho.vercel.app"
});

## Dashboard
Manage all your agent rules at: https://supra-wall-rho.vercel.app
