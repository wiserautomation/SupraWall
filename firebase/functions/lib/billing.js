...
exports.cleanupOldLogs = exports.resetMonthlyUsage = void 0;
 ...
 */
exports.resetMonthlyUsage = (0, scheduler_1.onSchedule)("0 0 1 * *", async (event) => {
 ...
 */
exports.cleanupOldLogs = (0, scheduler_1.onSchedule)("0 3 * * *", async (event) => {
    const now = new Date();
    // Retention limits:
