...
```
packages/
  cli/          - CLI tool for policy validation
  core/         - Shared types & security primitives
  dify-plugin/  - Integration for Dify.ai agents
  github-action/ - CI/CD policy enforcement
  mcp-plugin/   - Model Context Protocol (MCP) server
  sdk-go/       - Go SDK
  sdk-python/   - Python SDK
  sdk-ts/       - TypeScript/Node.js SDK
  server/       - Gateway & Policy Engine (Express)

plugins/
  langchain-py/ - LangChain Python integration
  langchain-ts/ - LangChain TypeScript integration
