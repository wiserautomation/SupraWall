...
export interface ComplianceBaseline {
    riskManagement: {
        enabled: boolean;
        registerAutoGenerated: boolean;
        preDeploymentGate: boolean;
        reviewIntervalDays: number;
        anomalyFeedbackLoop: boolean;
        vulnerableGroupsCheck: boolean;
    };
    dataGovernance: {
        enabled: boolean;
        dataSourceDeclarationRequired: boolean;
        relevanceCheck: boolean;
        biasThresholdAlert: boolean;
        biasThresholdPercent: number;
        dataLineageLogging: boolean;
    };
    technicalDocs: {
        enabled: boolean;
        annexIvWizard: boolean;
        sectionsRequired: string[];
        incompleteSectionsBlockDeploy: boolean;
        versioning: boolean;
    };
    logging: {
        enabled: boolean;
    ...
    transparency: {
        enabled: boolean;
        outputDisclosureLabel: boolean;
        disclosureText: string;
        deployerInstructionsRequired: boolean;
        endUserNotice: boolean;
    };
    humanOversight: {
        enabled: boolean;
        stopButton: boolean;
        safeHaltState: boolean;
        approvalGates: string[];
        automationBiasAlertThreshold: number;
        overrideLog: boolean;
        reviewerIdRequired: boolean;
    };
    accuracyRobustness: {
        enabled: boolean;
        performanceFloorRequired: boolean;
        anomalousInputDetection: boolean;
        fallbackOnLowConfidence: 'defer_to_human' | 'refuse' | 'flag';
        confidenceThreshold: number;
    };
    workflow: {
        qmsEnabled: boolean;
        conformityAssessmentRequired: boolean;
        declarationOfConformityGenerated: boolean;
        ceMarkingStatus: 'not_required' | 'pending' | 'certified';
        euDatabaseRegistered: boolean;
        postMarketMonitoringEnabled: boolean;
    };
}
