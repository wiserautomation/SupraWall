...
export function Navbar({ lang = 'en', dictionary }: { lang?: Locale, dictionary?: any }) {
    ...
    const solutions = [
        ...
        { type: "label", label: navbar.industries },
        { href: prefix("/for-hr-teams"), icon: <Users className="w-4 h-4 text-amber-400" />, label: "HR & Recruitment", desc: "Annex III compliance" },
        { href: prefix("/for-banking-teams"), icon: <DollarSign className="w-4 h-4 text-emerald-400" />, label: "Banking & Finance", desc: "DORA & AI Act ready" },
        { href: prefix("/for-healthcare-teams"), icon: <Activity className="w-4 h-4 text-rose-400" />, label: "Healthcare", desc: "Privacy for clinical AI" },
        { href: prefix("/for-legal-teams"), icon: <Scale className="w-4 h-4 text-blue-400" />, label: "Legal & Justice", desc: "Privilege protection" },
        { href: prefix("/for-executives"), icon: <Briefcase className="w-4 h-4 text-neutral-400" />, label: "C-Suite", desc: "Risk governance" },
    ];
