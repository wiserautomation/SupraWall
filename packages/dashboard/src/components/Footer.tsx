    ...
    return (
        <footer className="bg-black border-t border-white/5 py-32 px-6 text-neutral-500 font-bold uppercase tracking-widest text-[10px]">
            <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-16">
                ...
                <div>
                    <h4 className="font-black text-white uppercase text-xs tracking-widest mb-8">Industries</h4>
                    <ul className="space-y-4">
                        <li><Link href={prefix("/for-hr-teams")} className="hover:text-amber-500 transition-colors">HR & Recruitment</Link></li>
                        <li><Link href={prefix("/for-banking-teams")} className="hover:text-emerald-500 transition-colors">Banking & Finance</Link></li>
                        <li><Link href={prefix("/for-healthcare-teams")} className="hover:text-rose-500 transition-colors">Healthcare</Link></li>
                        <li><Link href={prefix("/for-legal-teams")} className="hover:text-blue-500 transition-colors">Legal & Justice</Link></li>
                        <li><Link href={prefix("/for-executives")} className="hover:text-neutral-500 transition-colors">C-Suite</Link></li>
                    </ul>
                </div>
                <div>
