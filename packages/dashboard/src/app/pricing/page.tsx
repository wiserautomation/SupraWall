...
import { Check, Zap, Shield, Users, ArrowRight, DollarSign, Loader2, Gauge, Lock, FileText, Activity, Layers, Globe, Github, Code2 } from 'lucide-react';
        ...
        <div className="min-h-screen bg-black text-white selection:bg-emerald-500/30 font-sans">
            ...
            <div className="relative pt-32 pb-20 px-6 text-center overflow-hidden">
                ...
                <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto mb-10 font-medium italic">
                    SupraWall is the open-source security layer for AI agents. Self-host it for free on your own infrastructure, or use SupraWall Cloud for a managed, compliance-ready experience.
                </p>
            </div>

            <div className="max-w-7xl mx-auto px-6">
                {/* 🎯 The 3-Column Pricing Grid */}
                <div className="grid lg:grid-cols-3 gap-8 mb-32 items-stretch">
                   
                    {/* Tier 1: Self-Host */}
                    <div className="p-10 rounded-[3rem] bg-neutral-900/30 border border-white/5 backdrop-blur-3xl flex flex-col justify-between hover:border-emerald-500/30 transition-all group">
                        <div className="space-y-6">
                            <div className="flex justify-between items-start">
                                <div className="p-3 bg-white/5 rounded-2xl text-neutral-400 group-hover:text-white transition-colors">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-3xl font-black italic uppercase tracking-tighter">Self-Host</h3>
                                <p className="text-xs font-bold text-neutral-500 uppercase italic leading-relaxed">Full SDK & Policy Engine on your own infrastructure.</p>
                            </div>
                            <div className="py-4">
                                <div className="text-5xl font-black italic tracking-tighter">$0</div>
                                <p className="text-[10px] font-black uppercase tracking-widest text-neutral-500 mt-2">Free Forever</p>
                            </div>
                            <ul className="space-y-3">
                                {["Open-Source Core", "Unlimited Agents", "Local Vault", "All 6 Framework Plugins", "Community Support"].map((item, id) => (
                    ...
                    {/* Tier 2: SupraWall Cloud (Featured) */}
                    <div className="p-10 rounded-[3rem] bg-emerald-600 border-2 border-emerald-400 text-white shadow-[0_40px_80px_rgba(16,185,129,0.2)] flex flex-col justify-between relative overflow-hidden scale-105 z-10">
                        ...
                        <div className="space-y-6 relative z-10">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs font-bold text-emerald-100 uppercase italic leading-relaxed">Managed infrastructure, compliance, and team features.</p>
                            </div>
                            <div className="py-4">
                                <div className="text-5xl font-black italic tracking-tighter">Usage-Based</div>
                                <p className="text-[10px] font-black uppercase tracking-widest text-emerald-200 mt-2">Starting at $0.002 / eval</p>
                            </div>
                            <ul className="space-y-3">
                                {["Managed Vault (HSM)", "Slack/Discord Approvals", "Compliance PDF Exports", "Unlimited Retention", "99.9% SLA"].map((item, id) => (
                                    <li key={id} className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest italic">
                    ...
                    <div className="p-10 rounded-[3rem] bg-neutral-900/30 border border-white/5 backdrop-blur-3xl flex flex-col justify-between hover:border-blue-500/30 transition-all group">
                        <div className="space-y-6">
                            <div className="flex justify-between items-start">
                                <div className="p-3 bg-white/5 rounded-2xl text-neutral-400 group-hover:text-blue-400 transition-colors">
                                    <Shield className="w-8 h-8" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <h3 className="text-3xl font-black italic uppercase tracking-tighter">Enterprise</h3>
                                <p className="text-xs font-bold text-neutral-500 uppercase italic leading-relaxed">Dedicated clusters, air-gapped, and certified safety.</p>
                            </div>
                            <div className="py-4">
                                <div className="text-5xl font-black italic tracking-tighter">Custom</div>
                                <p className="text-[10px] font-black uppercase tracking-widest text-neutral-500 mt-2">Tailored for Scale</p>
                            </div>
                            <ul className="space-y-3">
                                {["Self-Hosted / VPC", "SSO & SCIM", "White-Label Dashboard", "Certified PII Models", "24/7 Priority Support"].map((item, id) => (
                                    <li key={id} className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest italic text-neutral-400">
