                    ...
                    <div className="max-w-4xl mx-auto space-y-8">
                         ...
                         <div className="bg-neutral-900 rounded-[2.5rem] p-4 flex flex-col md:flex-row items-stretch md:items-center gap-4">
                             ...
                             <div className="flex gap-4">
                                 <Link href="https://github.com/wiserautomation/suprawall-mcp" className="p-6 bg-white text-black rounded-3xl font-black uppercase tracking-widest text-[10px] hover:bg-neutral-200 transition-all flex items-center gap-2">
