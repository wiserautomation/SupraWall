...
agent.invoke({"input": user_input})  # Trust the model. What could go wrong.`}
                        ...
                        <section className="space-y-8">
                            ...
                            <div className="space-y-3 p-8 rounded-3xl bg-white/[0.05] border border-white/5">
                                ...
                                <p className="text-lg text-neutral-400 leading-relaxed">
                                    Recursive tool call loops remain one of the most financially damaging failure modes in 2026. When an agent enters a semantic failure cycle — receiving an error from a tool and repeatedly retrying the same action — token costs compound exponentially. Without hard budget caps and loop detection at the runtime layer, a single misconfigured agent can consume thousands of dollars in API credits before anyone notices. The average runaway loop incident identified in our research cost $4,500. Detailed analysis in our <Link href="/learn/ai-agent-runaway-costs" className="text-emerald-500 underline decoration-emerald-500/30 hover:decoration-emerald-500 transition-all font-bold">AI Agent Runaway Costs guide</Link> shows that worst-case single incidents can exceed $180,000 over a long weekend where no on-call engineer was monitoring the bill.
                                </p>
                            </div>
