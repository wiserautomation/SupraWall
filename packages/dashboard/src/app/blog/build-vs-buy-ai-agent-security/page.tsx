...
export const metadata: Metadata = {
    title: "Build vs. Buy AI Agent Security: The 2026 Enterprise Decision Framework",
    description: "Build your own policy layer or use SupraWall? A 2,000-word deep dive into engineering hours, maintenance toil, and the EU AI Act compliance gap.",
