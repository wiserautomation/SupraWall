...
export function ResourceHub({ lang = 'en' }: { lang?: string }) {
    const resources = [
        ...
        { title: "LLM-as-Judge Fails for Agent Security", href: getLocalizedPath("/news/llm-as-judge-fails-agent-security", lang), desc: "4 documented bypass patterns. Why probabilistic guardrails cannot secure agent tool calls." },
