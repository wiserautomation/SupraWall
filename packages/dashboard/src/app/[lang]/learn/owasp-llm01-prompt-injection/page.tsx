...
export default function OWASPLLM01Page() {
    ...
    const faqSchema = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "What is OWASP LLM01: Prompt Injection - Deep Dive & Prevention?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "OWASP LLM01 is the top risk for large language models. Learn how it affects autonomous AI agents and how to implement deterministic defenses."
                }
            },
            {
                "@type": "Question",
                "name": "Why is OWASP LLM01: Prompt Injection - Deep Dive & Prevention important for AI agents?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            {
                "@type": "Question",
                "name": "Does SupraWall support OWASP LLM01: Prompt Injection - Deep Dive & Prevention compliance?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes. SupraWall provides the deterministic SDK-level middleware required to enforce security policies and generate audit logs for OWASP LLM01: Prompt Injection - Deep Dive & Prevention requirements."
                }
            }
        ]
    };
