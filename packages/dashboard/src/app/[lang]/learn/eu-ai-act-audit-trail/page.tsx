...
export default function EuAiActAuditTrailPage() {
    ...
    const faqSchema = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "What is EU AI Act Audit Trail Requirements for AI Agents (Article 12)?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Technical guide to Article 12 of the EU AI Act. Learn the mandatory logging and traceability requirements for high-risk autonomous AI systems."
                }
            },
            {
                "@type": "Question",
                "name": "Why is EU AI Act Audit Trail Requirements for AI Agents (Article 12) important for AI agents?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            {
                "@type": "Question",
                "name": "Does SupraWall support EU AI Act Audit Trail Requirements for AI Agents (Article 12) compliance?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes. SupraWall provides the deterministic SDK-level middleware required to enforce security policies and generate audit logs for EU AI Act Audit Trail Requirements for AI Agents (Article 12) requirements."
                }
            }
        ]
    };
