...
export default async function UseCasesHubPage({
    ...
    const jsonLd = {
        ...
        "url": `https://www.supra-wall.com/${lang}/use-cases`,
        "mainEntity": {
            "@type": "ItemList",
            "itemListElement": [
                { "@type": "ListItem", "position": 1, "name": "Financial Services Automation", "url": `https://www.supra-wall.com/${lang}/use-cases/financial-services` },
                { "@type": "ListItem", "position": 2, "name": "Healthcare AI Governance", "url": `https://www.supra-wall.com/${lang}/use-cases/healthcare` },
                { "@type": "ListItem", "position": 3, "name": "Legal AI Oversight", "url": `https://www.supra-wall.com/${lang}/use-cases/legal` },
                { "@type": "ListItem", "position": 4, "name": "Runaway Cost Control", "url": `https://www.supra-wall.com/${lang}/use-cases/cost-control` }
            ]
        },
        "breadcrumb": {
            "@context": "https://schema.org",
            ...
            "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Use Cases", "item": `https://www.supra-wall.com/${lang}/use-cases` }
            ]
        }
    };
