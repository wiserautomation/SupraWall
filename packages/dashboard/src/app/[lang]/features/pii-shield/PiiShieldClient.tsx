            ...
            <section className="relative pt-48 pb-32 px-6">
                ...
                <div className="max-w-7xl mx-auto flex flex-col items-center text-center space-y-12 relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 pt-4">
                        <Link href={`/${lang}/login`} className="px-14 py-6 bg-white text-black font-black uppercase tracking-tighter text-2xl rounded-2xl hover:bg-purple-500 hover:text-white transition-all transform hover:scale-105 shadow-[0_20px_40px_rgba(255,255,255,0.1)] group flex items-center gap-3">
             ...
             <section className="py-48 px-6 bg-black relative text-center">
                ...
                <div className="max-w-4xl mx-auto space-y-12 relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-6">
                        <Link href={`/${lang}/login`} className="px-16 py-8 bg-purple-600 text-white font-black text-3xl rounded-2xl hover:bg-purple-500 transition-all shadow-[0_0_100px_rgba(168,85,247,0.3)] tracking-tighter flex items-center gap-4 group">
