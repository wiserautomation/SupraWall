...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    const internalSlug = 'for-banking-teams';
    ...
    return {
        title: "AI Compliance for Banking | EU AI Act & DORA | SupraWall",
        description: "Automate EU AI Act Annex III and DORA compliance for your financial institution. Secure AI infrastructure.",
        alternates: {
...
export default async function ForBankingPage({
    params,
}: {
    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-blue-500/30">
            ...
            <BankingClient dictionary={dictionary} />
        </div>
    );
}
