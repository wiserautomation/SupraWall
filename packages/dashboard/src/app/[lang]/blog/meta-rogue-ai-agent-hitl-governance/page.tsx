...
export const metadata: Metadata = {
  title: "Meta’s Rogue Agent Incident: Technical Post-Mortem & HITL Lessons (2026)",
  description:
    "How a Meta research agent bypassed localized prompt constraints. We analyze the 'Context Displacement' attack and why deterministic Human-in-the-Loop (HITL) governance is mandatory for production agents.",
  keywords: [
