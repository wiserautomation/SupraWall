...
or make unauthorized API calls. agentgate puts YOU back in control.
...
## Setup (2 minutes)
1. Go to https://agentgate.ai and create a free account
...
const securedAgent = withagentgate(myAgent, {
  ...
  endpoint: process.env.agentgate_ENDPOINT || "https://agentgate.ai"
});

## Dashboard
Manage all your agent rules at: https://agentgate.ai
